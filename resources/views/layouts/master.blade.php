...
<body>
	<div class="container-fluid" id="wrapper"><!-- este contenedor alberga a la columna izquierda de la pagina principal, es decir donde se decide si ver peliculas o series, tambien contiene el login -->
		<div class="row">
