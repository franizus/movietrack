    ...
    <div class="col-3 mb-4">
        <div class="card" style="width:250px">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" onclick="openModal('{!! 'myModal' . $serie['id'] !!}')">Ver mas</a>
            </div>
        </div>
    </div>
    <div id="{!! 'myModal' . $serie['id'] !!}" class="modalmy">
        <div class="modalmy-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ $serie['original_name'] }}</h4>
                <button type="button" class="close" onclick="getElementById('{!! 'myModal' . $serie['id'] !!}').style.display ='none';">&times;</button>
            </div>
            <div class="container">
                <img src="{!! 'https://image.tmdb.org/t/p/w500' . $serie['backdrop_path'] !!}" width="100%">
                <div class="row top5">
