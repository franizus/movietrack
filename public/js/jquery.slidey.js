...
(function($) {
    $.slidey = function(el, options) {
        ...
        base.constructLayout = function() {
            ...
            // create controls
            var controls = "<div class='slidey-controls slidey-controls-previous'><i class='fas fa-chevron-left top1'></i></div>";
               controls += "<div class='slidey-controls slidey-controls-next'><i class='fas fa-chevron-right top1'></i></div>";
